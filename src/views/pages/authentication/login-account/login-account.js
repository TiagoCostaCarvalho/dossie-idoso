...
function LoginAccount() {
    ...
    return (
        ...
        <Box component="form" onSubmit={handleSubmit} noValidate>
            <div >
                <Typography variant="h4" align="center">Entrar no DossiêIdoso </Typography>
            </div>
        ...
        <Box><Typography variant="h6" align="center"> Ainda não tem conta?<br /> <a href="/signup">criar conta</a></Typography></Box>
        </Container>
    )
}
